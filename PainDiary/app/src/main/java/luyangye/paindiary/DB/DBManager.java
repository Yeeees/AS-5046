...
public class DBManager {
    ...
    public static final String DATABASE_NAME = "PainDiary.db";
    private Context context;
    private static final String TEXT_TYPE = " TEXT";
    private static final String COMMA_SEP = ",";
    private static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            DBStructure.tableEntry.TABLE_NAME + " (" + DBStructure.tableEntry._ID + " INTEGER PRIMARY KEY,"
            + DBStructure.tableEntry.COLUMN_ID + TEXT_TYPE + COMMA_SEP
            + DBStructure.tableEntry.COLUMN_ADDR + TEXT_TYPE + COMMA_SEP + DBStructure.tableEntry.COLUMN_LAT + TEXT_TYPE + COMMA_SEP + DBStructure.tableEntry.COLUMN_LONG + TEXT_TYPE + COMMA_SEP
            + DBStructure.tableEntry.COLUMN_DATE + TEXT_TYPE + COMMA_SEP + DBStructure.tableEntry.COLUMN_TIME + TEXT_TYPE +" );";
...
//    };
    ...
    public long insertUser(String userid, String address, String latitude, String longtitude, String date, String time) {
        ContentValues values = new ContentValues();
        values.put(DBStructure.tableEntry.COLUMN_ID, userid);
        values.put(DBStructure.tableEntry.COLUMN_ADDR, address);
        values.put(DBStructure.tableEntry.COLUMN_LAT, latitude);
        values.put(DBStructure.tableEntry.COLUMN_LONG, longtitude);
